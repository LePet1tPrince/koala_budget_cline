...
class PlaidItem(models.Model):
    ...
    """
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='plaid_integration_items')
    account = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='plaid_integration_connection')
...
class PlaidTransaction(models.Model):
    ...
    transaction = models.ForeignKey(Transaction, on_delete=models.CASCADE, related_name='plaid_integration_source')
